        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Momentos = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    KittyName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    KittyXP = table.Column<int>(type: "int", nullable: false),
                    KittyXPNextLevel = table.Column<int>(type: "int", nullable: false),
                    KittyLevel = table.Column<int>(type: "int", nullable: false),
                    KittyType = table.Column<int>(type: "int", nullable: false),
                    FoodPower = table.Column<int>(type: "int", nullable: false),
                    FoodName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SpecialFood = table.Column<int>(type: "int", nullable: false),
                    SpecialFoodName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    KittyStatus = table.Column<int>(type: "int", nullable: false),
                    KittyRank = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Kittys", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Kittys_PlayerProfiles_PlayerProfileID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Kittys_PlayerProfileID",
                table: "Kittys",
